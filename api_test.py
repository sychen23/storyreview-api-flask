...
class ScoredStoryTests(unittest.TestCase):
    ...
    async def test_calculate_general_consistency_score(self):
        score = await self.story.calculate_general_consistency_score()
        self.assertAlmostEqual(score, 0.8, places=2)

    async def test_calculate_character_consistency_score(self):
        score = await self.story.calculate_character_consistency_score()
        self.assertAlmostEqual(score, 0.9, places=2)

    async def test_calculate_plot_consistency_score(self):
        score = await self.story.calculate_plot_consistency_score()
        self.assertAlmostEqual(score, 0.7, places=2)

    async def test_calculate_score_general_character(self):
        await self.story.calculate_score(['general_consistency_score', 'character_consistency_score'])
    ...
    async def test_calculate_score_plot(self):
        await self.story.calculate_score(['plot_consistency_score'])
